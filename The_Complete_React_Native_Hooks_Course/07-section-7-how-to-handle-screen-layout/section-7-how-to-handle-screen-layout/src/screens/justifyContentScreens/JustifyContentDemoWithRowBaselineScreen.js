...
const JustifyContentDemoWithRowBaselineScreen = () => {
    let subtitle = 'Learn how to handle screen layout with justify content';

    return (
        <View style={appStyles.paddingStyle}>
            <Text style={appStyles.titleStyle}>Row Baseline With Justify Content</Text>
...
export default JustifyContentDemoWithRowBaselineScreen;