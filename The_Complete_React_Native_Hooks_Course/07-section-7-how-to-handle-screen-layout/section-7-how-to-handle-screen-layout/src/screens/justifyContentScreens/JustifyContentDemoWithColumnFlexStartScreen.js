...
const JustifyContentDemoWithColumnFlexStartScreen = () => {
    let subtitle = 'Learn how to handle screen layout with justify content';

    return (
        <View style={appStyles.paddingStyle}>
            <Text style={appStyles.titleStyle}>Column Flex-Start With Justify Content</Text>
...
export default JustifyContentDemoWithColumnFlexStartScreen;