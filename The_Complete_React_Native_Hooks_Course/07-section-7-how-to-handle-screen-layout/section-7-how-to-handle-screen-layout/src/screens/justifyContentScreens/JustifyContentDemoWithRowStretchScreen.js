...
const JustifyContentDemoWithRowStretchScreen = () => {
    let subtitle = 'Learn how to handle screen layout with justify content';

    return (
        <View style={appStyles.paddingStyle}>
            <Text style={appStyles.titleStyle}>Row Stretch With Justify Content</Text>
...
export default JustifyContentDemoWithRowStretchScreen;